...
<div class="container-fluid">
    ...
    <div class="topbar">
        <div>
            <h1>Pending Fees</h1>
            <div class="topbar-sub">View all pending fee payments</div>
        </div>
                ...
                <tbody>
                    @forelse($payments as $index => $payment)
                        <tr>
                            ...
                            <td>
                                <span class="amount-badge-pending">₹ {{ number_format($payment->amount, 2) }}</span>
                            </td>
                            <td>
                                <span class="date-badge">
                                    <i class="ti ti-calendar"></i>
                                    {{ $payment->due_date ? $payment->due_date->format('d M Y') : ($payment->created_at ? $payment->created_at->format('d M Y') : now()->format('d M Y')) }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="{{ route('fee-payments.destroy', $payment->id) }}"
                                        ...
                                        <button type="submit"
                                                class="btn-delete"
                                                onclick="return confirm('Are you sure you want to delete this pending fee record?')">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <div class="empty-sub">All fees have been paid! 🎉</div>
